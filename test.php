...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('taiwan-post','LH902049195TW',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "LH902049195TW",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("taiwan-post","LH902049195TW",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'LH902049195TW',
//        'carrier_code'    => 'taiwan-post',
//        'title'          => '4PX page',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('taiwan-post','LH902049195TW',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('taiwan-post','LH902049195TW');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("taiwan-post","LH902049195TW",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("LH902049195TW","taiwan-post","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"LH902049195TW","carrier_code"=>"taiwan-post");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"taiwan-post");
